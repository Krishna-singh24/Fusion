...
const Alert: React.FC<AlertProps> = ({ title, description, variant = 'filled', color = 'primary', icon = undefined }) => {
  return (
    <div className={clsx(cssColors.classes[color], "flex gap-x-3 items-start p-4 mb-4 text-sm text-blue-800 rounded-lg dark:bg-gray-800 dark:text-blue-400")} role="alert">
